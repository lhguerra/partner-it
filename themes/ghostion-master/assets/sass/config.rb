...
css_dir               = "../css"              # - The path for placing compiled
                                              ...
                                              #   directory.
images_dir            = "../img"              # - The place Compass will look for
...
generated_images_dir  = "../img/sprites"      # - Where compass will place the
...
# this directory.
add_import_path 'ghostion'
add_import_path 'partner'
